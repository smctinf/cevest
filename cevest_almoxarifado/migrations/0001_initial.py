    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_inclusao', models.DateTimeField(auto_now_add=True, verbose_name='Dt. Inclusão')),
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cevest_almoxarifado.tipo_material')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_movimentacao', models.CharField(choices=[('E', 'Entrada'), ('S', 'Saída')], default='E', max_length=1)),
                ('add_quantidade', models.IntegerField(verbose_name='Quantidade movimentada')),
                ('qnt_em_estoque', models.IntegerField(null=True)),
                ('dt_inclusao', models.DateTimeField(auto_now_add=True, verbose_name='Dt. Inclusão')),
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cevest_almoxarifado.material')),
            ],
            options={
